# Real Estate Agent Suite — $199 one-time install
...
Real estate agents and teams who want to spend less time on paperwork and more time with clients. Works for residential, commercial, and luxury markets.

---

## Upgrade Path

Pair with the [Executive Leadership Suite](../executive-leadership-suite/PACKAGE.md) if you're running a team or brokerage and need ops and comms tooling alongside client-facing skills.
